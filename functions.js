...
function printGreeting() {
    console.log("Welcome! We are happy to meet you!");
}
printGreeting();
printGreeting();
printGreeting();
...
function printFarewell(name) {
    console.log(`Hate to see you go ${name}!`);
  }
  printFarewell("James");
...
function printPayRange(company, max, min) {
  var range = max - min;
  console.log(`The current pay range at ${company} is ${range}.`);
}
printPayRange("Kitty Cat Co", 95, 75);
